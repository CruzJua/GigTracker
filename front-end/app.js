...
app.get("/edit-shift/:id", (req, res) => {
  ...
  let url = api_url + "getShiftById/" + id;
  fetch(url)
    .then((response) => response.json())
    .then((data) => {
      let date = data.data.date.slice(0, data.data.date.indexOf("T"));
      console.log(
        "Data that is being passed to the edit-shift page",
        data.data,
      );
...
app.get("/edit-earning/:id", (req, res) => {
  const id = req.params.id;
  let url = api_url + "getEarningById/" + id;
  fetch(url)
    .then((response) => response.json())
    .then((data) => {
      let date = data.data.date.slice(0, data.data.date.indexOf("T"));
      console.log(
        "Data that is being passed to the edit-earning page",
        data.data,
      );
...
app.get("/delete-shift/:id", (req, res) => {
  const id = req.params.id;
  let url = api_url + "delete-shift/" + id;
  fetch(url)
    .then((response) => response.json())
    .then((data) => {
...
app.get("/delete-earning/:id", (req, res) => {
  const id = req.params.id;
  let url = api_url + "delete-earning/" + id;
  fetch(url)
    .then((response) => response.json())
    .then((data) => {
      console.log("Data that was deleted", data);
